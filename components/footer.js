        ...
        <footer className="text-center text-gray-600 bg-gray-100 lg:text-left">
            <div className="flex items-center justify-center p-6 border-b border-gray-300 lg:justify-between">
                ...
                <div className="flex justify-center">
                    <a href="https://www.instagram.com/panchamb63/" target='_blank' rel='noopener noreferrer' className="mr-6 text-gray-600">
                    ...
                    <a href="https://www.linkedin.com/in/pancham-barman-50/" target='_blank' rel='noopener noreferrer' className="mr-6 text-gray-600">
                    ...
                    <a href="https://github.com/Pancham555/" target='_blank' rel='noopener noreferrer' className="text-gray-600">
            ...
            <div className="py-10 mx-6 text-center md:text-left">
                <div className="flex flex-wrap justify-evenly">
                    ...
                    <div className="w-56 my-5">
                        ...
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600">Landing site</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600">Web app</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600">Mobile app</a>
                        </p>
                        <p>
                            <a href="#!" className="text-gray-600">Full Stack website</a>
                        </p>
                    </div>
                    ...
                    <div className="my-5 w-80">
                        ...
                        <p className="flex items-center justify-center mb-4 md:justify-start">
                            ...
                            Nalbari, Pin no 781335, Assam, India
                        </p>
                        <p className="flex items-center justify-center mb-4 md:justify-start">
            ...
            <div className="p-6 text-center bg-gray-200">
                ...
                <a className="font-semibold text-gray-600" href="#">Pancham Barman</a>
            </div>
        </footer >
    )
}

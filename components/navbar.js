...
const Navbar = (props) => {
    ...
    return (
        <>
            <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800 fixed top-0 left-0 right-0 z-50 shadow-sm shadow-blue-50">
